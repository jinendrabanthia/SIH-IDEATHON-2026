...
import { Search, Sun, Moon, Globe, User, LogOut, Settings, LayoutDashboard } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <header className="fixed top-0 right-0 left-64 h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center px-6 z-30 gap-4 transition-colors">
        ...
        <div className="relative">
          ...
          {showProfileMenu && (
            <div className="absolute top-full right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden z-50 w-48">
              ...
              <button className="w-full text-left px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-3 transition-colors">
              ...
              <button className="w-full text-left px-4 py-2.5 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 flex items-center gap-3 transition-colors">
