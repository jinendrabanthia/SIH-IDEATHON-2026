...
const IndiaMap: React.FC = () => (
  <svg viewBox="0 0 1000 1000" className="w-full" style={{ maxHeight: '230px' }}>
    <defs>
      <clipPath id="ic">
        <path d={INDIA_PATH} transform="translate(100, 950) scale(0.08, -0.08)" />
      </clipPath>
    </defs>

    {/* Fill */}
    <path d={INDIA_PATH} transform="translate(100, 950) scale(0.08, -0.08)" fill="#eff6ff" className="dark:fill-slate-800/60" />

    {/* Internal dotted dividers clipped to shape */}
    <g clipPath="url(#ic)" stroke="#94a3b8" strokeWidth="4" strokeDasharray="12 24" strokeLinecap="round" fill="none">
    ...
    {/* Dotted outer border */}
    <path d={INDIA_PATH} transform="translate(100, 950) scale(0.08, -0.08)" fill="none" stroke="#64748b" strokeWidth="10"
      strokeDasharray="8 28" strokeLinecap="round" strokeLinejoin="round" />

    {/* Region dots (scaled roughly 4x from original) */}
    <circle cx="370" cy="350" r="24" fill="#f97316" /> {/* North */}
    <circle cx="850" cy="450" r="24" fill="#ec4899" /> {/* NE */}
    <circle cx="200" cy="550" r="24" fill="#10b981" /> {/* West */}
    <circle cx="450" cy="580" r="24" fill="#f59e0b" /> {/* Central */}
    <circle cx="650" cy="600" r="24" fill="#3b82f6" /> {/* East */}
    <circle cx="390" cy="850" r="24" fill="#8b5cf6" /> {/* South */}
  </svg>
);
